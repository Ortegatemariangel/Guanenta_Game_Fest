...
# arboles
arboles = [
    pygame.Rect(80, 150, 20, 40),
    pygame.Rect(130, 190, 20, 40),
    pygame.Rect(400, 140, 20, 40),
    pygame.Rect(110, 330, 20, 40),
    pygame.Rect(470, 350, 20, 40),
    pygame.Rect(200, 160, 20, 40),
    pygame.Rect(300, 220, 20, 40),
    pygame.Rect(500, 100, 20, 40),
    pygame.Rect(50, 250, 20, 40),
    pygame.Rect(520, 270, 20, 40),
    pygame.Rect(150, 100, 20, 40),
    pygame.Rect(430, 300, 20, 40),
]
...
def fondo():
    ...
    for arbol in arboles:
        pygame.draw.rect(ventana, (34, 139, 34), arbol)
...
def reiniciar():
    global pelota_x, pelota_y, vx, vy, en_movimiento, victoria, arrastrando, punto_inicio
...
while True:
    ...
    # Rebotes con los bordes del campo
...
# Reajustar para que no se quede fuera
    ...
    for arbol in arboles[:]:
        if pelota_rect.colliderect(arbol):
            vx = -vx
            vy = -vy
